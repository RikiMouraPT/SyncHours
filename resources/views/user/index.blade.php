...
<body class="min-h-screen bg-gray-50 flex flex-col">
  ...
  <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Configuração Atual do Horário Semanal</h1>
        @if(isset($userConfig))
    ...
    <div class="mt-6 flex justify-end">
        <a href="{{ route('user.create') }}" class="bg-rose-600 text-white px-4 py-2 rounded hover:bg-rose-700">Modificar Atividades</a>
    </div>
  </main>
</body>
</html>